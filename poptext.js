document.getElementById("title").innerHTML = `A Good Man is Hard to Find`

document.getElementById("author").innerHTML = `by Flannery O'Connor`

document.getElementById("copyright").innerHTML = `From: Flannery O'Connor: Collected Works the Library of America
